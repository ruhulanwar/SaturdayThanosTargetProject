...
@CucumberOptions(features = { "src/test/resource/FeatureFiles" }, glue = { "upskill.target.stepDef",
		"upskill.utilities" }, tags = { "@regression" }, plugin = { "pretty", "html:target/cucumber-htmlreport",
